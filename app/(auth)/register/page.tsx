...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setLoading(false);
      toast({ title: "Account created", description: "Check your email to verify.", variant: "success" });
    }, 1500);
  };
    ...
    <Card className="w-full max-w-md min-w-0">
      ...
      <CardContent>
        ...
        <div className="grid grid-cols-2 gap-3">
          <Button variant="outline" onClick={() => toast({ title: "Google auth", description: "Wire to your OAuth provider." })}>
          ...
          <Button variant="outline" onClick={() => toast({ title: "GitHub auth", description: "Wire to your OAuth provider." })}>
